...
public class XmlUtilTest {
    ...
    public void getDataFromFile_nullFile_throwsNullPointerException() throws Exception {
        ...
        XmlUtil.getDataFromFile(null, PredictiveTranscript.class);
    }
    ...
    public void getDataFromFile_missingFile_fileNotFoundException() throws Exception {
        ...
        XmlUtil.getDataFromFile(MISSING_FILE, PredictiveTranscript.class);
    }

    @Test
    public void getDataFromFile_emptyFile_dataFormatMismatchException() throws Exception {
        thrown.expect(JAXBException.class);
        XmlUtil.getDataFromFile(EMPTY_FILE, PredictiveTranscript.class);
    }

    @Test
    public void getDataFromFile_validFile_validResult() throws Exception {
        PredictiveTranscript dataFromFile = XmlUtil.getDataFromFile(VALID_FILE, XmlSerializableAddressBook.class).toModelType();
    ...
    public void saveDataToFile_nullFile_throwsNullPointerException() throws Exception {
        thrown.expect(NullPointerException.class);
        XmlUtil.saveDataToFile(null, new PredictiveTranscript());
    }
    ...
    public void saveDataToFile_missingFile_fileNotFoundException() throws Exception {
        thrown.expect(FileNotFoundException.class);
        XmlUtil.saveDataToFile(MISSING_FILE, new PredictiveTranscript());
    }

    @Test
    public void saveDataToFile_validFile_dataSaved() throws Exception {
        FileUtil.createFile(TEMP_FILE);
        XmlSerializableAddressBook dataToWrite = new XmlSerializableAddressBook(new PredictiveTranscript());
        XmlUtil.saveDataToFile(TEMP_FILE, dataToWrite);
        XmlSerializableAddressBook dataFromFile = XmlUtil.getDataFromFile(TEMP_FILE, XmlSerializableAddressBook.class);
        assertEquals(dataToWrite, dataFromFile);

        AddressBookBuilder builder = new AddressBookBuilder(new PredictiveTranscript());
