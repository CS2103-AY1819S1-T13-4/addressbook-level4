...
public class XmlAddressBookStorageTest {
    ...
    private java.util.Optional<ReadOnlyTranscript> readAddressBook(String filePath) throws Exception {
    ...
    public void readAndSaveAddressBook_allInOrder_success() throws Exception {
        ...
        PredictiveTranscript original = getTypicalAddressBook();
        XmlAddressBookStorage xmlAddressBookStorage = new XmlAddressBookStorage(filePath);

        //Save in new file and read back
        xmlAddressBookStorage.saveAddressBook(original, filePath);
        ReadOnlyTranscript readBack = xmlAddressBookStorage.readAddressBook(filePath).get();
        assertEquals(original, new PredictiveTranscript(readBack));
     ...
     */
    private void saveAddressBook(ReadOnlyTranscript addressBook, String filePath) {
        try {
    ...
    public void saveAddressBook_nullFilePath_throwsNullPointerException() {
        thrown.expect(NullPointerException.class);
        saveAddressBook(new PredictiveTranscript(), null);
    }
