...
public class TestApp extends MainApp {
    ...
    protected Supplier<ReadOnlyTranscript> initialDataSupplier = () -> null;
    protected Path saveFileLocation = SAVE_LOCATION_FOR_TESTING;

    public TestApp() {
    }

    public TestApp(Supplier<ReadOnlyTranscript> initialDataSupplier, Path saveFileLocation) {
        super();
     ...
     */
    public PredictiveTranscript readStorageAddressBook() {
        try {
            return new PredictiveTranscript(storage.readAddressBook().get());
